...
public class WoSalesAgentResource {
    ...
    public ResponseEntity<WoSalesAgentDTO> createWoSalesAgent(@Valid @RequestBody WoSalesAgentDTO woSalesAgentDTO) throws URISyntaxException {
    ...
    public ResponseEntity<WoSalesAgentDTO> updateWoSalesAgent(@Valid @RequestBody WoSalesAgentDTO woSalesAgentDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, woSalesAgentDTO.getId().toString()))
            .body(result);
    }
    ...
    public List<WoSalesAgentDTO> getAllWoSalesAgents() {
        log.debug("REST request to get all WoSalesAgents");
        return woSalesAgentService.findAll();
    }
