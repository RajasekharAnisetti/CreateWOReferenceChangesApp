...
export class WoWorkOrderService {
  ...
  protected convertDateFromClient(woWorkOrder: IWoWorkOrder): IWoWorkOrder {
    const copy: IWoWorkOrder = Object.assign({}, woWorkOrder, {
      ...
      jobDeadlineDate:
        woWorkOrder.jobDeadlineDate != null && woWorkOrder.jobDeadlineDate.isValid()
          ? woWorkOrder.jobDeadlineDate.format(DATE_FORMAT)
          : null
    });
    return copy;
  }
  ...
  protected convertDateFromServer(res: EntityResponseType): EntityResponseType {
    if (res.body) {
      ...
      res.body.jobDeadlineDate = res.body.jobDeadlineDate != null ? moment(res.body.jobDeadlineDate) : null;
    }
    return res;
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((woWorkOrder: IWoWorkOrder) => {
        ...
        woWorkOrder.jobDeadlineDate = woWorkOrder.jobDeadlineDate != null ? moment(woWorkOrder.jobDeadlineDate) : null;
      });
    }
    return res;
  }
